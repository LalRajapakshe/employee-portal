...
import type { LoanDashboardSummary } from '@/types/loan';

type Payload = { success: boolean; data?: LoanDashboardSummary; message?: string; correlationId?: string };
...
export async function GET(request: NextRequest) {
  ...
  const result = await callCoreApi<Payload>('/api/loans/summary', {
